        ...
        <form class="row" method="POST" action="{{ route('admin.coupons.update', $coupon) }}">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="discount" value="{{$coupon->discount}}" name="discount" placeholder="Nhập Discount">
                    @error('discount')
                        <span style="color: red"><i class="fa-solid fa-circle-exclamation fa-beat"></i>
                            {{ $message }}</span>
                    @enderror
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="class" value="{{$coupon->min_price}}" name="min_price" placeholder="Nhập Class">
                    @error('min_price')
                        <span style="color: red"><i class="fa-solid fa-circle-exclamation fa-beat"></i>
                            {{ $message }}</span>
                    @enderror
